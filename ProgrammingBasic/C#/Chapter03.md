...
### (1) C# Delegate    
  **① Delegate의 선언** 
  ...
  - Delegate를 선언할 때 반환 형식과 매개변수는 할당되는 Method와 동일한 형태를 가지고 있어야 한다. 다른 형태를 가지고 있을 경우에는 할당되지 않는다.
...
```
  ...
  > [C# 백견불여일타](https://www.aladin.co.kr/shop/wproduct.aspx?ItemId=215750847)  
